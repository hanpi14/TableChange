...
public class GetDataFormatAndDate {



    public static String getDataFormatAndDate(String input,String date){

        // 正则表达式和替换 '%Y%m%d' 为 'yyyyMMdd'，首先替换这个，因为它是更具体的格式
    ...
    private static String replaceDate(String input,String date) {
        ...
        while (dateMatcher.find()) {
            ...
            String newDate = incrementMonth(matchedDate.replaceAll("'", ""),date);
    ...
    private static String incrementMonth(String str,String date) {
