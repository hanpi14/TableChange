             ...
             IFNULL(IF(element_at(from_json(O.detail_title, 'array<string>'), 4) = '费用月份(示例: 2021-01)',
                       DATE_FORMAT(CONCAT(element_at(from_json(P.detail_data, 'array<string>'), 4), '-01'),
                                   'yyyyMM'), NULL), DATE_FORMAT(CONCAT(O.order_month, '-01'),
                                                                 'yyyyMM'))       AS fee_month,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 15) = 'HRO服务费-外包服务费金额',
                element_at(from_json(P.detail_data, 'array<string>'), 15) + 0, 0) AS income_reward,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 5) = 'HRO服务费-薪资金额',
                element_at(from_json(P.detail_data, 'array<string>'), 5) + 0, 0)  AS income_order_payroll,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 6) = 'HRO服务费-薪资残保金金额',
                element_at(from_json(P.detail_data, 'array<string>'), 6) + 0, 0)  AS income_order_disabled,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 7) = 'HRO服务费-薪资个税金额',
                element_at(from_json(P.detail_data, 'array<string>'), 7) + 0, 0)  AS income_order_tax,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 9) = 'HRO服务费-其他金额',
                element_at(from_json(P.detail_data, 'array<string>'), 9) + 0, 0)  AS income_order_other,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 11) = 'HRO服务费-公积金金额',
                element_at(from_json(P.detail_data, 'array<string>'), 11) + 0, 0) AS income_order_type_2,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 10) = 'HRO服务费-社保金额',
                element_at(from_json(P.detail_data, 'array<string>'), 10) + 0, 0) AS income_order_type_1,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 12) = 'HRO服务费-社保残保金金额',
                element_at(from_json(P.detail_data, 'array<string>'), 12) + 0, 0) AS income_order_type_1_disabled,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 14) = 'HRO服务费-员工福利金额',
                element_at(from_json(P.detail_data, 'array<string>'), 14) + 0, 0) AS income_order_welfare
