             ...
             IFNULL(IF(element_at(from_json(O.detail_title, 'array<string>'), 4) = '费用月份(示例: 2021-01)',
                       DATE_FORMAT(CONCAT(element_at(from_json(P.detail_data, 'array<string>'), 4), '-01'),
                                   'yyyyMM'), NULL), DATE_FORMAT(CONCAT(O.order_month, '-01'),
                                                                 'yyyyMM'))       AS fee_month,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 15) = '全球雇国内转移外包-外包服务费金额',
                element_at(from_json(P.detail_data, 'array<string>'), 15) + 0,
                0)                                                                AS income_reward,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 5) = '全球雇国内转移外包-薪资金额',
                element_at(from_json(P.detail_data, 'array<string>'), 5) + 0,
                0)                                                                AS income_order_payroll,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 6) = '全球雇国内转移外包-薪资残保金金额',
                element_at(from_json(P.detail_data, 'array<string>'), 6) + 0,
                0)                                                                AS income_order_disabled,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 7) = '全球雇国内转移外包-个税金额',
                element_at(from_json(P.detail_data, 'array<string>'), 7) + 0,
                0)                                                                AS income_order_tax,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 9) = '全球雇国内转移外包-其他金额',
                element_at(from_json(P.detail_data, 'array<string>'), 9) + 0,
                0)                                                                AS income_order_other,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 11) = '全球雇国内转移外包-公积金金额',
                element_at(from_json(P.detail_data, 'array<string>'), 11) + 0,
                0)                                                                AS income_order_type_2,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 10) = '全球雇国内转移外包-社保金额',
                element_at(from_json(P.detail_data, 'array<string>'), 10) + 0,
                0)                                                                AS income_order_type_1,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 12) = '全球雇国内转移外包-社保残保金金额',
                element_at(from_json(P.detail_data, 'array<string>'), 12) + 0, 0)
                                                                                  AS income_order_type_1_disabled,
             IF(element_at(from_json(O.detail_title, 'array<string>'), 14) = '全球雇国内转移外包-员工福利金额',
