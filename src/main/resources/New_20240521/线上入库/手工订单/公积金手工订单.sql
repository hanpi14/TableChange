...
SELECT -1                                                                     AS data_source,
       ...
       B.gongjijin_zhengce                                                    AS order_item,
       ...
       IF(B.shebao_amount = 0, B.daili_fuwufei / 10000, 0)                    AS income_reward,
       IF(B.shebao_amount = 0, B.daili_fuwufei / 10000, 0)                    AS raw_income_reward,
       IF(C.single_flag = 1, 0, B.gongjijin_amount / 10000)                   AS income_order,
       B.gongjijin_amount / 10000                                             AS raw_income_order,
       B.gongjijin_zhinajin / 10000                                           AS income_overdue,
       ...
       B.gongjijin_jishu / 10000                                              AS order_parm,
       0                                                                      AS indv_net_pay,
       ...
       B.gongjijin_danwei_amount                                              AS corp_fund_amount,
       B.gongjijin_danwei_percent                                             AS corp_fund_rate,
       B.gongjijin_geren_amount                                               AS indv_fund_amount,
       B.gongjijin_geren_percent                                              AS indv_fund_rate,
