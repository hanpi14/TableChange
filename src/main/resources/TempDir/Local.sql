...
FROM (dw.dwd.dwd_ar_mi FOR SYSTEM_TIME AS OF '2024-05-18 03:00:00') A
         LEFT JOIN (dw.dwd.mid_product_business_mapping FOR SYSTEM_TIME AS OF '2024-05-18 03:00:00') B
